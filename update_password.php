...
<tr>
    ...
    <input type="password" name="op"  placeholder="Enter your old password" class="form-control" required/></th>
</tr>
	
<tr>
	<th height="93">New Password:
    <input type="password" name="np"  placeholder="Enter your new password" class="form-control"  required/><br /></th>
</tr>
 
<tr>
	<th height="87">Confirm Password:
    <input type="password" name="cp" placeholder="Re-enter your new password" class="form-control" required/><br /></th>
</tr>
<tr>
